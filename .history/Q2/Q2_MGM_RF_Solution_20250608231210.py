...
class MGM_RF_Inferencer:
    ...
    def __init__(self, q1_model_path: str = None, saple_id: str = None):
        # 初始化组件
        self.pseudo_freq_calculator = PseudoFrequencyCalculator()
        self.genotype_enumerator = GenotypeEnumerator(max_contributors=Q1FeatureEngineering.extract_noc_from_filename(saple_id))
...
class MGM_RF_Pipeline:
    ...
    def __init__(self, q1_model_path: str = None, saple_id: str= None):
        self.mgm_rf_inferencer = MGM_RF_Inferencer(q1_model_path, saple_id)
        self.results = {}
