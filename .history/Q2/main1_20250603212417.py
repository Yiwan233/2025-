...
class GenotypeEnumerator:
    ...
    def enumerate_valid_genotype_sets(self, observed_alleles: List[str], 
        ...
        f= open("P2_MCMC_Corrected_V10.txt", "a", encoding="utf-8")
        ...
        # 分析混合模式
        # 计算主要贡献者比例
        if 'contributor_ranking' in summary:
            main_contributor_ratio = summary[f'Mx_{summary["contributor_ranking"][0][0]}']['mean']
        else:
            main_contributor_ratio = 1.0
