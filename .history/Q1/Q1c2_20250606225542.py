...
for i, param in enumerate(key_params):
    ...
    try:
        ...
        axes[i].fill_between(x_axis, train_mean - train_std/2, train_mean + train_std/2, alpha=0.1, color='blue')
        axes[i].fill_between(x_axis, validation_mean - validation_std/2, validation_mean + validation_std/2, alpha=0.1, color='red')
