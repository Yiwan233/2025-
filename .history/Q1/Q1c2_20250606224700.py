...
for i, param in enumerate(key_params):
    ...
    try:
        ...
        axes[i].fill_between(x_axis, train_mean - train_std, train_mean + train_std, alpha=0.05, color='blue')
        axes[i].fill_between(x_axis, validation_mean - validation_std, validation_mean + validation_std, alpha=0.05, color='red')
