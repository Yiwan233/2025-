# -*- coding: utf-8 -*-
"""
数学建模 - 法医DNA分析 - 问题1：贡献者人数识别 (RFECV + 梯度提升机优化版)

版本: V6.0 - RFECV Feature Selection + Optimized Gradient Boosting
日期: 2025-06-03
描述: 使用RFECV进行特征选择 + 专注梯度提升机优化 + 中文特征名称
"""
...
# 机器学习相关
from sklearn.model_selection import train_test_split, cross_val_score, StratifiedKFold, GridSearchCV, RandomizedSearchCV, validation_curve
from sklearn.metrics import accuracy_score, confusion_matrix, classification_report, roc_curve, auc, make_scorer, f1_score
...
print("=== 法医混合STR图谱NoC智能识别系统 (RFECV + 梯度提升机优化版) ===")
print("专注于RFECV特征选择 + 梯度提升机深度优化")
...
PLOTS_DIR = os.path.join(DATA_DIR, 'noc_rfecv_gb_plots')
...
def extract_comprehensive_features(sample_file, sample_peaks):
    """提取完整的特征集（基于文档V5方案）"""
