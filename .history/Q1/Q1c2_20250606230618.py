...
for i, param in enumerate(key_params):
    ...
    try:
        ...
        axes[i].fill_between(x_axis, train_mean - train_std/4, train_mean + train_std/4, alpha=0.1, color='blue')
        axes[i].fill_between(x_axis, validation_mean - validation_std/3, validation_mean + validation_std/3, alpha=0., color='red')
