...
FEATURE_NAME_MAPPING = {
    ...
    '等位基因数大于等位基因数大于等于3的位点比例': '≥3等位基因位点比例',
    '等位基因数大于等位基因数大于等于4的位点比例': '≥4等位基因位点比例',
    '等位基因数大于等位基因数大于等于5的位点比例': '≥5等位基因位点比例',
    '等位基因数大于等位基因数大于等于6的位点比例': '≥6等位基因位点比例',
    '等位基因数大于等位基因数大于等于7的位点比例': '≥7等位基因位点比例',
    '等位基因数大于等位基因数大于等于8的位点比例': '≥8等位基因位点比例',
